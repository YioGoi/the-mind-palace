    ...
    <SafeAreaView style={[styles.container, { backgroundColor: 'transparent' }]}>
      {loading ? (
        <View style={styles.loadingContainer}>
          <ActivityIndicator size="large" color={colors.colorSuccess} />
        </View>
      ) : (
        <>
          <SectionList
          ...
          <NewNoteModal
            ...
            onCreated={() => setNewNoteOpen(false)}
          />

          <Fab testID="fab-have" onPress={() => setNewNoteOpen(true)} color={colors.colorSuccess} />
        </>
      )}
    </SafeAreaView>
  )
